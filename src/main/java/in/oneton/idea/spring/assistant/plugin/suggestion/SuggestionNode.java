...
public interface SuggestionNode extends OriginalNameProvider, DocumentationProvider, SuggestionNodeTypeProvider {
     ...
     * attempted to be matched. If a result is found, it will be returned. Else null
    ...
    SortedSet<Suggestion> findKeySuggestionsForQueryPrefix(Module module, FileType fileType,
                                                           List<SuggestionNode> matchesRootTillMe, int numOfAncestors
            , String[] querySegmentPrefixes, int querySegmentPrefixStartIndex, @Nullable Set<String> siblingsToExclude);
