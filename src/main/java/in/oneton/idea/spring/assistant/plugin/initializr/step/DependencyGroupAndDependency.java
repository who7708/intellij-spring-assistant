...
public class DependencyGroupAndDependency implements Indexable {
    ...
    static class DependencyGroupAndDependencyAdapter implements IndexAdapter<DependencyGroupAndDependency> {
        ...
        public Collection<ScoredObject<DependencyGroupAndDependency>> get(String token) {
            // TODO: Not sure the value of threshold here :). Following sample from https://github
            //  .com/fmmfonseca/completely/blob/master/sample/src/main/java/com/miguelfonseca/completely
            //  /SampleAdapter.java
