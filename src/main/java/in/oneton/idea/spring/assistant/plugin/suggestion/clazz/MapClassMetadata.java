...
public class MapClassMetadata extends ClassMetadata {
    ...
    @Override
    protected Collection<? extends SuggestionDocumentationHelper> doFindDirectChildrenForQueryPrefix(Module module,
    ...
    @Override
    protected Collection<? extends SuggestionDocumentationHelper> doFindDirectChildrenForQueryPrefix(Module module,
                                                                                                     String querySegmentPrefix, @Nullable Set<String> siblingsToExclude) {
        return doWithKeyDelegateOrReturnNull(delegate -> delegate.findDirectChildrenForQueryPrefix(module,
                querySegmentPrefix, siblingsToExclude));
    }
    ...
    protected List<SuggestionNode> doFindDeepestSuggestionNode(Module module,
        ...
        return doWithKeyDelegateOrReturnNull(keyProxy -> {
            ...
            SuggestionDocumentationHelper directChildKeyMatch = keyProxy.findDirectChild(module, pathSegment);
            if (directChildKeyMatch != null) {
                ...
                if (lastPathSegment) {
                    ...
                    return doWithValueDelegateOrReturnNull(valueProxy -> valueProxy.findDeepestSuggestionNode(module,
                            matchesRootTillParentNode, pathSegments, pathSegmentStartIndex + 1));
                }
            }
            return null;
        });
    ...
    @Nullable
    @Override
    protected SortedSet<Suggestion> doFindKeySuggestionsForQueryPrefix(Module module, FileType fileType,
                                                                       List<SuggestionNode> matchesRootTillParentNode
            , int numOfAncestors, String[] querySegmentPrefixes, int querySegmentPrefixStartIndex) {
        return doFindKeySuggestionsForQueryPrefix(module, fileType, matchesRootTillParentNode, numOfAncestors,
    ...
    protected SortedSet<Suggestion> doFindValueSuggestionsForPrefix(Module module, FileType fileType,
        ...
        return doWithValueDelegateOrReturnNull(proxy -> {
            ...
            assert valueIsLeaf;
            return proxy.findValueSuggestionsForPrefix(module, fileType, matchesRootTillMe, prefix, siblingsToExclude);
        });
    }

    public SortedSet<Suggestion> findChildKeySuggestionForQueryPrefix(Module module, FileType fileType,
                                                                      List<SuggestionNode> matchesRootTillMe,
                                                                      int numOfAncestors,
                                                                      String[] querySegmentPrefixes,
                                                                      int querySegmentPrefixStartIndex,
                                                                      @Nullable Set<String> siblingsToExclude) {
        return doWithValueDelegateOrReturnNull(proxy -> proxy.findKeySuggestionsForQueryPrefix(module, fileType,
                matchesRootTillMe, numOfAncestors, querySegmentPrefixes, querySegmentPrefixStartIndex,
                siblingsToExclude));
    }
    ...
    protected String doGetDocumentationForValue(Module module, String nodeNavigationPathDotDelimited,
        ...
        return doWithValueDelegateOrReturnNull(proxy -> proxy.getDocumentationForValue(module,
                nodeNavigationPathDotDelimited, originalValue));
    }
    ...
    private void init(Module module, PsiClassType type) {
        if (isValidType(type)) {
            ...
            Optional<PsiTypeParameter> keyTypeParam =
                    typeParameterKetSet.stream().filter(v -> requireNonNull(v.getName()).equals("K")).findFirst();
            Optional<PsiTypeParameter> valueTypeParam =
                    typeParameterKetSet.stream().filter(v -> requireNonNull(v.getName()).equals("V")).findFirst();
    ...
    private <T> T doWithKeyDelegateOrReturnNull(MetadataProxyInvokerWithReturnValue<T> targetInvokerWithReturnValue) {
    ...
    private <T> T doWithValueDelegateOrReturnNull(MetadataProxyInvokerWithReturnValue<T> targetInvokerWithReturnValue) {
        return doWithValueDelegateAndReturn(targetInvokerWithReturnValue, null);
    }

    private <T> T doWithValueDelegateAndReturn(MetadataProxyInvokerWithReturnValue<T> targetInvokerWithReturnValue,
    ...
    class MapKeySuggestionNode implements SuggestionNode {
        ...
        public SortedSet<Suggestion> findValueSuggestionsForPrefix(Module module, FileType fileType,
                                                                   ...
                                                                   String prefix,
                                                                   @Nullable Set<String> siblingsToExclude) {
            return doWithValueDelegateOrReturnNull(proxy -> proxy.findValueSuggestionsForPrefix(module, fileType,
                    matchesRootTillMe, prefix, siblingsToExclude));
        }
        ...
        public SuggestionNodeType getSuggestionNodeType(Module module) {
            return doWithValueDelegateAndReturn(proxy -> proxy.getSuggestionNodeType(module), UNKNOWN_CLASS);
        }
