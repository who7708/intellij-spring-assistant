...
public class DependencyDetail implements DependencySelectionChangeListener, DependencySelection.VersionUpdateListener {
    ...
    public void onDependencySelected(@Nullable Dependency dependency) {
        ...
        if (dependency != null) {
            ...
            if (!dependency.isVersionCompatible(version)) {
                ...
                incompatibleLabel.setText("Requires Spring boot/cloud version " + requireNonNull(dependency.getVersionRange()).toString());
            ...
            if (linksContainer != null) {
                ...
                if (guideLinks != null) {
                    ...
                    guideLinks.forEach(guideLink -> guidesContainer.add(newHyperLink(guideLink, version.toString())));
                ...
                if (references != null) {
                    ...
                    references.forEach(reference -> referenceContainer.add(newHyperLink(reference,
                            version.toString())));
