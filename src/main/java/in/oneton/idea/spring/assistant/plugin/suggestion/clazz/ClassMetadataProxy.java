...
public class ClassMetadataProxy implements MetadataProxy {
    ...
    private static final ConcurrentMap<String, Key<CachedValue<ClassMetadata>>> fqnToKey = ContainerUtil.newConcurrentMap();
    ...
    public SuggestionDocumentationHelper findDirectChild(Module module, String pathSegment) {
        return doWithTargetAndReturn(module, target -> target.findDirectChild(module, pathSegment), null);
    }
    ...
    public Collection<? extends SuggestionDocumentationHelper> findDirectChildrenForQueryPrefix(Module module,
        ...
        return doWithTargetAndReturn(module, target -> target.findDirectChildrenForQueryPrefix(module,
    ...
    public List<SuggestionNode> findDeepestSuggestionNode(Module module,
        ...
        return doWithTargetAndReturn(module, target -> target.findDeepestSuggestionNode(module,
    ...
    public SortedSet<Suggestion> findKeySuggestionsForQueryPrefix(Module module, FileType fileType,
        ...
        return doWithTargetAndReturn(module, target -> target.findKeySuggestionsForQueryPrefix(module, fileType,
                matchesRootTillMe, numOfAncestors, querySegmentPrefixes, querySegmentPrefixStartIndex), null);
    }
    ...
    public SortedSet<Suggestion> findValueSuggestionsForPrefix(Module module, FileType fileType,
                                                               List<SuggestionNode> matchesRootTillMe, String prefix,
                                                               @Nullable Set<String> siblingsToExclude) {
        return doWithTargetAndReturn(module, target -> target.findValueSuggestionsForPrefix(module, fileType,
    ...
    public String getDocumentationForValue(Module module, String nodeNavigationPathDotDelimited, String originalValue) {
        return doWithTargetAndReturn(module, target -> target.getDocumentationForValue(module,
    ...
    <T> T doWithTargetAndReturn(Module module, TargetInvokerWithReturnValue<T> targetInvokerWithReturnValue,
    ...
    private ClassMetadata getTarget(Module module) {
        ...
        if (fqn != null) {
            ...
            Key<CachedValue<ClassMetadata>> classMetadataKey = ConcurrencyUtil.cacheOrGet(fqnToKey, userDataKeyRef,
                    Key.create(userDataKeyRef));
