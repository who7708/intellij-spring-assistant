...
public final class ClassSuggestionNodeFactory {
    ...
    static ClassMetadata newClassMetadata(@NotNull PsiType type) {
        ...
        switch (nodeType) {
            ...
            case UNKNOWN_CLASS:
                return new DummyClassMetadata(nodeType);
            default:
                throw new IllegalStateException("Class suggestion node for the specified class " + type + " is " +
                        "undefined");
        }
    }
    ...
    public static MetadataProxy newMetadataProxy(Module module, @NotNull PsiType type) {
        ...
        throw new IllegalAccessError("Supports only PsiArrayType, PsiPrimitiveType & PsiClassType types");
    }
