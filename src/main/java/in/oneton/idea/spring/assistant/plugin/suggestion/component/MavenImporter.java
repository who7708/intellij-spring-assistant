...
public class MavenImporter extends org.jetbrains.idea.maven.importing.MavenImporter {
    ...
    @Override
    public void preProcess(Module module, MavenProject mavenProject, MavenProjectChanges mavenProjectChanges,
    ...
    public void process(IdeModifiableModelsProvider ideModifiableModelsProvider, Module module,
        ...
        if (!"true".equals(skip)) {
            ...
            debug(() -> log.debug("Skipping index check for project " + module.getProject().getName() + " & module " + module.getName()));
        }
    }
