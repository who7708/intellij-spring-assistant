...
/**
 * Finds {@link YAMLKeyValue}s with {@link YAMLMapping}s as values, and finds the corresponding schema model. Marks any
 * child properties within the mapping which do not exist in the model as an error.
 */
