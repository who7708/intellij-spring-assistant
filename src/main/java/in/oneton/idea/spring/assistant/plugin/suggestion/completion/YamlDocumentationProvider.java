...
public class YamlDocumentationProvider extends AbstractDocumentationProvider {
        ...
        if (element instanceof DocumentationProxyElement) {
            ...
            if (target != null && target.supportsDocumentation()) {
                ...
                if (proxyElement.requestedForTargetValue) {
                    return target.getDocumentationForValue(module, proxyElement.nodeNavigationPathDotDelimited,
                            proxyElement.value);
                } else {
    ...
    /*
     * This will called if the user tries to lookup documentation for the choices being shown (ctrl+q within
     * suggestion dialog)
     */
    @Override
    ...
    public PsiElement getCustomDocumentationElement(@NotNull Editor editor, @NotNull PsiFile file,
        ...
        if (element != null) {
            ...
            SuggestionService suggestionService = ServiceManager.getService(element.getProject(),
            ...
            if (ancestralKeys != null) {
                matchedNodesFromRootTillLeaf = suggestionService.findMatchedNodesRootTillEnd(project, module,
                        ancestralKeys);
                if (matchedNodesFromRootTillLeaf != null) {
                    ...
                    String targetNavigationPathDotDelimited =
                            matchedNodesFromRootTillLeaf.stream().map(v -> v.getNameForDocumentation(module)).collect(joining("."));
