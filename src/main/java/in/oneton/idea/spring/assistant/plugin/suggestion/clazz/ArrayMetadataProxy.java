...
public class ArrayMetadataProxy implements MetadataProxy {
    ...
    public Collection<? extends SuggestionDocumentationHelper> findDirectChildrenForQueryPrefix(Module module,
        ...
        return doWithDelegateAndReturn(delegate -> delegate.findDirectChildrenForQueryPrefix(module,
                querySegmentPrefix, siblingsToExclude), null);
    }
    ...
    public List<SuggestionNode> findDeepestSuggestionNode(Module module,
        ...
        return doWithDelegateAndReturn(delegate -> {
            ...
            if (directChildKeyMatch != null) {
                ...
                matchesRootTillParentNode.add(new IterableKeySuggestionNode((SuggestionNode) directChildKeyMatch));
    ...
    public SortedSet<Suggestion> findKeySuggestionsForQueryPrefix(Module module, FileType fileType,
        ...
        return findKeySuggestionsForQueryPrefix(module, fileType, matchesRootTillParentNode, numOfAncestors,
    ...
    private <T> T doWithDelegateAndReturn(MetadataProxyInvokerWithReturnValue<T> targetInvokerWithReturnValue,
