    ...
    private class DummyKeySuggestionDocumentationHelper implements SuggestionDocumentationHelper {
        ...
        public Suggestion buildSuggestionForKey(Module module, FileType fileType,
            ...
            Suggestion.SuggestionBuilder builder =
                    Suggestion.builder().suggestionToDisplay(dotDelimitedOriginalNames(matchesRootTillMe,
                            numOfAncestors)).numOfAncestors(numOfAncestors).matchesTopFirst(matchesRootTillMe).icon(nodeType.getIcon()).fileType(fileType);
