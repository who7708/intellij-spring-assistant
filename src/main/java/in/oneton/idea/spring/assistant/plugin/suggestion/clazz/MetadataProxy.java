 ...
 * plugin is operating on,
 * it is possible that the target class is no longer available in the classpath due to change of dependencies. So, lets
 * always access target via the proxy so that we dont have to worry about whether the target class exists in classpath
 * or not
 */
public interface MetadataProxy {
    ...
    @Nullable
    Collection<? extends SuggestionDocumentationHelper> findDirectChildrenForQueryPrefix(Module module,
    ...
    @Nullable
    List<SuggestionNode> findDeepestSuggestionNode(Module module, List<SuggestionNode> matchesRootTillParentNode,
    ...
    @Nullable
    String getDocumentationForValue(Module module, String nodeNavigationPathDotDelimited, String originalValue);
