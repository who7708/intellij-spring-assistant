...
public class SelectedDependenciesTableModel extends AbstractTableModel implements VersionUpdateListener,
        DependencyAdditionListener, DependencySelectionChangeListener, DependencyRemovalListener {
    ...
    SelectedDependenciesTableModel(JBTable selectedDependencies, ProjectCreationRequest request) {
        ...
        // Since clicking on the same row to delete dependency thats already selected does not trigger a new
        // ListSelection event, we should rely on mouse click events for deletes
    ...
    public void onDependencyAdded(@NotNull Dependency dependency) {
        ...
        if (added) {
            ...
            ignoreNextSelection = true;
            fireTableDataChanged();
            selectedDependencies.getSelectionModel().setSelectionInterval(indexOfDependency, indexOfDependency);
        }
    }
    ...
    class InplaceButtonTableCellRenderer extends DefaultTableCellRenderer {
        ...
        public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
            InplaceButton inplaceButton = new InplaceButton(new IconButton("Click to delete", DeleteContentFolder, DeleteContentFolderRollover), e -> {
            });
