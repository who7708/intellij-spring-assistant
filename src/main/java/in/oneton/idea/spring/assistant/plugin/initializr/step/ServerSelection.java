...
public class ServerSelection {
    private static final String SPRING_ASSINSTANT_INITIALIZR_LAST_KNOWN_SERVER_URL = "spring.assinstant.initializr" +
            ".last.known.server.url";
    private static final String SPRING_IO_DEFAULT_INITIALIZR_SERVER_URL = "https://start.spring.io";
    private static final String SPRING_IO_DATAFLOW_INITIALIZR_SERVER_URL = "https://start-scs.cfapps.io";
    ...
    public void init(ProjectCreationRequest request) {
        ...
        // If user entered default/dataflow url in the custom field & moved ahead, lets remove those values from
        // custom field
        List<String> urlHistory = customTextFieldWithHistory.getHistory();
        urlHistory.removeIf(url -> url.equals(SPRING_IO_DEFAULT_INITIALIZR_SERVER_URL) || url.equals(SPRING_IO_DATAFLOW_INITIALIZR_SERVER_URL));
        ...
        String serverUrl = request.isServerUrlSet() ? request.getServerUrl() :
    ...
    public void updateDataModel() {
        ...
        getInstance().setValue(SPRING_ASSINSTANT_INITIALIZR_LAST_KNOWN_SERVER_URL, request.getServerUrl());
    }
    ...
    private void createUIComponents() {
        ...
        customTextFieldWithHistory = new TextFieldWithStoredHistory("spring.assistant.initializr.custom.server.url.history");
    }
}
